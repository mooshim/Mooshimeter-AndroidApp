...
public class ThermocoupleHelper {
    ...
    public static final helper J = new helper(new double[]{
            0.0,
            1.978425e-2,
            -2.001204e-7,
            1.036969e-11,
    ...
    public static final helper E = new helper(new double[]{
            0.0,
            1.7057035e-2,
            -2.3301759e-7,
            6.5435585e-12,
    ...
    public static final helper N = new helper(new double[]{
            0.0,
            3.8783277e-2,
            -1.1612344e-6,
            6.9525655e-11,
    ...
    public static final helper B = new helper(new double[]{
            9.842332e1,
            6.997150e-1,
            -8.4765304e-4,
            1.0052644e-6,
    ...
    public static final helper R = new helper(new double[]{
            0.0,
            1.8891380e-1,
            -9.3835290e-5,
            1.3068619e-7,
    ...
    public static final helper S = new helper(new double[]{
            0.0,
            1.84949460e-1,
            -8.00504062e-5,
            1.02237430e-7,
