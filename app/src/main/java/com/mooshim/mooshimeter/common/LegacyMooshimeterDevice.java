...
public class LegacyMooshimeterDevice extends BLEDeviceBase {
    ...
    private abstract class MeterStructure {
         ...
         */
        public void update() {
            unpack(mInstance.mPwrap.req(getUUID()));
        }
         ...
         */
        public int send() {
            return mInstance.mPwrap.send(getUUID(), pack());
        }
        ...
        public boolean isNotificationEnabled() {
            return mInstance.mPwrap.isNotificationEnabled(getUUID());
        }
        ...
        public int enableNotify(boolean enable, final NotifyHandler on_notify) {
            return mInstance.mPwrap.enableNotify(getUUID(), enable, new NotifyHandler() {
                  @Override
